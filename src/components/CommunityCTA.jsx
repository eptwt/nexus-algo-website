      ...
      <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6">
        ...
        <div className="max-w-md mx-auto">
          ...
          <div className="bg-card border border-border/50 rounded-xl p-6 sm:p-8 text-center hover:border-[#5865F2]/30 transition-all duration-300">
            ...
            <h3 className="text-lg font-bold mb-2">Join Our Active Discord Server</h3>
            <p className="text-sm text-muted-foreground mb-5">
              Get real-time support, share setups, and connect with fellow traders.
            </p>
            <a
              href="https://discord.gg/nexusalgo"
              target="_blank"
